...
class LicenseService {
  ...
  ///
  /// Rotated 2026-09-06 (key-2026-09): the previous public key was retired
  /// after the signing seed was treated as exposed. Keys minted with the
  /// retired seed no longer verify. The private seed lives ONLY in the
  /// server environment (LICENSE_PRIVATE_KEY) — never in this repo.
