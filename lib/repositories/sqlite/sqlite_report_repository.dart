...
class SqliteReportRepository implements ReportRepository {
  ...
  Future<List<CustomerStatement>> getCustomerStatements(
          String customerKey, DateTime from, DateTime to,
          {String? currencyCode}) =>
      ReportService.getCustomerStatements(customerKey, from, to,
          currencyCode: currencyCode);
  @override
  Future<List<TopProduct>> getTopProducts(DateTime from, DateTime to,
          {int limit = 500, String? currencyCode, bool rankByProfit = false}) =>
      ReportService.getTopProducts(from, to,
          limit: limit, currencyCode: currencyCode, rankByProfit: rankByProfit);
  @override
  ...
  @override
  Future<List<InvoiceStatusRow>> getInvoiceStatusList(
