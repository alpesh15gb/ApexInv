    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Payment of ${selected.first.bill.currencySymbol} '
              '${_allocated.toStringAsFixed(2)} posted.'),
      ...
      body: _loading
          ...
          : _bills.isEmpty
              ? const AppEmptyState(
                  ...
                  title: 'There are no outstanding purchase bills.')
              : Column(children: [
                  Padding(
                      ...
                      child: LayoutBuilder(builder: (context, constraints) {
                        final fields = <Widget>[
                          ...
                          DropdownButtonFormField<String>(
                              value:
                                  accountChoices.any((a) => a.id == _accountId)
                                      ? _accountId
                                      : null,
                              decoration: const InputDecoration(
                                  labelText: 'Pay from',
                      ...
                      child: Row(children: [
                        ...
                        Column(
                            ...
                            children: [
                              ...
                              AppMoney(_allocated,
                                  currencySymbol: _visible.isEmpty
                                      ? ''
                                      : _visible.first.currencySymbol,
                                  bold: true),
                            ]),
                        const SizedBox(width: 16),
                        FilledButton.icon(
