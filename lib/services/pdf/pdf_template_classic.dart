    ...
    build: (context) => [
      ...
      pw.Center(
        child: pw.Text(
          ...
          style: pw.TextStyle(
              fontWeight: pw.FontWeight.bold,
              fontSize: classicPdfStyle.typeFont),
        ),
      ),
      pw.Row(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
            ...
            children: [
              pw.Container(
                padding: pw.EdgeInsets.symmetric(
                    horizontal: classicPdfStyle.sectionPadding,
                    vertical: classicPdfStyle.sectionPadding),
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text(invoice.customer.name,
                        style: pw.TextStyle(
                            fontWeight: pw.FontWeight.bold,
                            fontSize: classicPdfStyle.bodyFontSize)),
            ...
            children: [
              ...
              if (invoice.dueDate != null)
                pw.Text(
                    ...
                    style:
                        pw.TextStyle(fontSize: classicPdfStyle.bodyFontSize)),
            ],
          ),
        ],
      ),
      pw.SizedBox(height: 5),
      buildInvoiceTable(invoice, InvoiceTemplate.classic,
