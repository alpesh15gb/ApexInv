...
pw.MultiPage buildExecutiveTemplate(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          ...lines.where((line) => line.trim().isNotEmpty).map((line) =>
              pw.Text(line,
                  style:
                      pw.TextStyle(fontSize: executivePdfStyle.bodyFontSize))),
        ],
      ),
    );
  }
  ...
  return pw.MultiPage(
    ...
    build: (context) => [
              ...
              children: [
                ...
                if (showAddress)
                  pw.Text(company?.address ?? '',
                      style: pw.TextStyle(
                          fontSize: executivePdfStyle.subtitleFontSize)),
                if (showPhone)
      ...
      buildInvoiceTable(invoice, InvoiceTemplate.executive,
      ...
      pw.Row(
        ...
        children: [
          ...
          buildEnhancedTotals(invoice, PdfColors.grey200, PdfColors.black,
