    ...
    build: (context) => [
      ...
      pw.Center(
        child: pw.Text(
          ...
          style: pw.TextStyle(
              fontWeight: pw.FontWeight.bold,
              fontSize: modernPdfStyle.typeFont),
        ),
      ),
      pw.Padding(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(invoice.customer.name,
                      style: pw.TextStyle(
                          fontSize: modernPdfStyle.bodyFontSize,
                          fontWeight: pw.FontWeight.bold)),
              ...
              children: [
                ...
                if (invoice.dueDate != null)
                  pw.Text(
                      ...
                      style:
                          pw.TextStyle(fontSize: modernPdfStyle.bodyFontSize)),
              ],
            ),
          ],
        ),
      ...
      pw.Padding(
        ...
        child: pw.Row(
          ...
          children: [
            pw.Expanded(
                child: buildAdditionalNotes(invoice, accentColor: accentColor)),
            pw.SizedBox(width: 20),
            buildEnhancedTotals(invoice, PdfColors.blue200, PdfColors.black,
      ...
      if (signatureImage != null ||
        ...
        pw.Padding(
          padding:
              pw.EdgeInsets.symmetric(horizontal: PdfLayout.defaultHMargin),
          child: pw.Row(
            crossAxisAlignment: pw.CrossAxisAlignment.start,
            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
            children: signaturePosition == 'right'
                ? [
                    buildBankUpiRow(
                      ...
                      amount: invoice.payableTotal + previousBalanceDue,
