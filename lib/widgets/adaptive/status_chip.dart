...
class StatusChip extends StatelessWidget {
  ...
  static (Color, Color) colorsFor(Brightness brightness, StatusTone tone) {
    return (brightness == Brightness.dark ? _dark : _light)[tone]!;
  }

  @override
  Widget build(BuildContext context) {
    final (background, foreground) =
        colorsFor(Theme.of(context).brightness, tone);
    return Container(
  ...
  static const _light = <StatusTone, (Color, Color)>{
  ...
  static const _dark = <StatusTone, (Color, Color)>{
