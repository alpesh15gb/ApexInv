...
#if [[ -f assets/deb/com.apexbooks.desktop ]]; then
#  cp assets/deb/com.apexbooks.desktop AppDir/com.apexbooks.desktop.desktop
#else
#  echo "⚠️ Warning: com.apexbooks.desktop not found, skipping..."
#fi
